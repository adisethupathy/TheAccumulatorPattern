...
def run_test_count_cosines_from():
    ...
    #test2
    expected = 27
    answer = count_cosines_from(4, 69, 0.3)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    #test3
    expected = 10
    answer = count_cosines_from(1, 51, 0.8)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    #test4
    expected = 17
    answer = count_cosines_from(2, 72, 0.7)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    #test5
    expected = 43
    answer = count_cosines_from(8, 100, 0.1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    #test6
    expected = 38
    answer = count_cosines_from(6, 85, 0.05)
