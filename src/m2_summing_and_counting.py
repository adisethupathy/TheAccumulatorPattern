...
def run_test_count_sines_vs_cosines():
    ...
    #test6
    expected = 7
    answer6 = count_sines_vs_cosines(8)
    ...
    #test7
    expected = 9
    actual = count_sines_vs_cosines(9)
    ...
    #test8
    expected = 11
    actual = count_sines_vs_cosines(10)
    ...
    #test9
    expected = 12
    actual = count_sines_vs_cosines(11)
    ...
    #test10
    expected = 12
    actual = count_sines_vs_cosines(12)
    ...
    #test11
    expected = 12
    actual = count_sines_vs_cosines(13)
